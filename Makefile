...
# Golang package.
PKG := github.com/thanhbinhdoan1993/pratice-kuard

# Registry to push to.
REGISTRY ?= thanhbinhdoan1993/kuar-demo

# For demo purposes, we want to build multiple versions. They will all be 
# mostly the same but will let us demostrate rollouts.
FAKEVER ?= blue
...
$(BIN_DOCKERFILE): Dockerfile.kuard
	@echo "generating Dockefile $@ from $<"
	sed \
		-e 's|ARG_ARCH|$(ARCH)|g' \
