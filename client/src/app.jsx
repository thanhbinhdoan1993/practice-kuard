            ...
            <div className="top">
                ...
                <div className="nav-container">
                    <div className="nav">
                        ...
                        <HighlightLink href={base + "-/keygen"} className="nav-item">MemQ Server</HighlightLink>
                        <HighlightLink href={base + "/fs"} className="nav-item">File system browser</HighlightLink>
                    </div>
